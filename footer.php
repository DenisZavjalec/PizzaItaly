...
<footer class="footer-page">
  <div class="container">
    <div class="footer-page__text">PizzaTime 2023</div>
  </div>
</footer>
<!-- /.footer-page -->
        ...
        <ul class="socials">
          <li class="socials__item">
            <a href="#" class="socials__link" target="_blank">
              <svg class="socials__icon socials__icon--vk" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 112.2 112.2"
                width="35" height="35">
                <g>
          ...
          <li class="socials__item">
            <a href="#" class="socials__link" target="_blank">
              <svg class="socials__icon socials__icon--fb" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 112.2 112.2"
                width="35" height="35">
                <g>
                  <circle cx="56.1" cy="56.1" r="56.1" />
                  <path class="socials__logo"
        ...
        <div class="order">
          ...
          <form class="form form-send">
            ...
            <select class="form__input" name="оплата">
              <option value="Оплата наличными">Оплата після доставки</option>
              <option value="Оплата картой">Оплата картою</option>
            </select>
...
if($_SERVER['REQUEST_METOD']== 'POST'){
  $name = $_POST['Denis'];
  $phone = $_POST['+380680490015'];
  $adress = $_POST['Головна'];
  $payment = $_POST['Готівка'];

  $sid = 'ACa98a679ec20dce1c904cc2ec55eedaff';
  $token = 'f50df42dfdac3ad4d3bf9bc2a202f0c3';

  $fromNumber = '+1 812 594 9252';
